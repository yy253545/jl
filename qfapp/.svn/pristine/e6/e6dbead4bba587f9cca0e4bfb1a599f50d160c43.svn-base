<template>
  <div class="s-canvas wh flex flexAro">
    <canvas id="code_canvas" ref="code" :width="contentWidth" :height="contentHeight"></canvas>
  </div>
</template>
...
export default {
  ...
  props: {
    ...
    fontSizeMax: { type: Number, default: 26 },
    ...
    contentWidth: { type: Number, default:118 },
    contentHeight: { type: Number, default: 33 }
  },
  data() {
    return {};
  },
